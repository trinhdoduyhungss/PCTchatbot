...
class TextClassifier:
    ...
    def train(self, X, y):
        ...
        self.model.fit(X, y, batch_size=self.batch_size, epochs=self.n_epochs, validation_split=0.2)
...
if __name__ == '__main__':
    ...
    data_path = root_dir + '/processed_data4.csv'



    word2vec_model = Word2Vec.load('VNCorpus9.bin')
    keras_text_classifier = TextClassifier(word2vec_dict=word2vec_model, model_path='sentiment_model9.h5',
                                           max_length=10, n_epochs=100)
    ...
    test_sentence = ['hello', 'hi','bye','chào tạm biệt', 'tạm biệt nha', 'Lê Duẩn là ai ?', 'einstein','cảm ơn', 'cân bằng phản ứng sau']
    #test_sentence = ['bye']
